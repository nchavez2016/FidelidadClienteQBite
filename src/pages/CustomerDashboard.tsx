...
function SocialIcon({ name }: { name: string }) {
  return (
    <svg viewBox="0 0 96 96" aria-hidden="true" className="h-12 w-12 drop-shadow-md sm:h-14 sm:w-14">
      ...
      {name === "Instagram" && <><rect x="25" y="25" width="46" height="46" rx="14" fill="none" stroke="hsl(var(--primary))" strokeWidth="7" /><circle cx="48" cy="48" r="12" fill="none" stroke="hsl(var(--primary))" strokeWidth="7" /><circle cx="63" cy="33" r="5" fill="hsl(var(--primary))" /></>}
