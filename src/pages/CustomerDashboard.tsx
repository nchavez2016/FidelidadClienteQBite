...
export default function CustomerDashboard() {
  ...
  // Estado vacío estructurado con Flexbox para forzar el footer al final
  if (activeCampaigns.length === 0) {
    return (
      <div className="min-h-screen flex flex-col justify-between" style={{ background: "#f0f4f8" }}>
        <div className="w-full flex-1 flex flex-col">
          <HeroSection
            ...
            activeCampaigns={[]}
          />
          <div className="max-w-[560px] mx-auto px-5 mt-8 text-center flex-1">
            <div
  ...
  // Estado principal estructurado correctamente con flex-col y min-h-screen
  return (
    <div className="min-h-screen flex flex-col justify-between" style={{ background: "#f0f4f8" }}>
      <div className="w-full flex-1">
        ...
        <div
          className="max-w-[720px] mx-auto flex flex-col px-3 pb-5 sm:px-4 sm:pb-6"
      ...
      {/* El Footer queda fijado de manera independiente al fondo */}
      <SocialFooter />
    </div>
  );
}
