        ...
        {customer && (
          <div className="space-y-4">
            ...
            {lockedFromRequest && selectedReward ? (
              <div className="rounded-lg p-3 flex items-start gap-3" style={{ background: 'rgba(232,161,69,0.08)', border: '1.5px solid #E8A145' }}>
                <Hourglass className="w-5 h-5 mt-0.5" style={{ color: '#E8A145' }} />
